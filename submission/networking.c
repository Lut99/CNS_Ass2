...
int create_tcp_pkt(libnet_ptag_t* tcp, libnet_ptag_t* ipv4, libnet_t* l, uint8_t flags, uint32_t source_ip, uint16_t source_port, uint32_t target_ip, uint16_t target_port, uint32_t seq_number, uint32_t ack_number, const uint8_t* payload, uint32_t payload_size) {
...
int probe_tcp_seq(uint32_t* results, libnet_t* l, pcap_t* p, uint32_t source_ip, uint16_t source_port, uint32_t target_ip, uint16_t target_port, uint16_t n) {
